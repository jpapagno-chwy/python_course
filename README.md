...
use git for everything. I expect each project to be checked up to your repo. use git add, git commit -m, and git push to cleanly add code to a repo of your own.

before each project in this repo, do the assigned lectures on Udemy. These projects should not take you too long to code, if they do, you probably missed a lecture. If you are stuck however, contact me or look online for some help.
...
![Autocomplete Settings](autocomplete.png)

If you think a lesson is too easy for you, great. Do it anyways. The more time you have coding without AI, the more your confidence will grow.
